...
#            'all':'/ueditor/UE/third-party/SyntaxHighlighter/shCoreDefault.css',
        ...
        try:
            js += (
                ...
                '/ueditor/UE/lang/zh-cn/zh-cn.js',
            )
        except AttributeError:
            raise ImproperlyConfigured("ueditor requires ")
    ...
    def render(self, name, value, attrs=None):
        ...
        return mark_safe(render_to_string('ueditor/widget.html', {
